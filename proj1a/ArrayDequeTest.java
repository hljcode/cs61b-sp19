...
public class ArrayDequeTest {
    ...
    /*Utility method for printing out value comparision. */
    ...
    public static void addRemoveTest() {
        ...
        System.out.println("Test if the removal is effective");
    ...
    public static void addGetTest(){
        ...
        lld1.printDeque();
        passed=checkValue(10,lld1.get(3))&&passed;
       // passed=checkValue(30,lld1.get_Recursive(1))&&passed;
    ...
    public static void main(String[] args){
        System.out.println("Running tests./n");
        // addIsEmptySizeTest();
        addRemoveTest();
       // addGetTest();
    }
